...
+ (nullable FLTVersion *)nullableFromList:(NSArray *)list { return (list) ? [FLTVersion fromList:list] : nil; }
- (NSArray *)toList {
  return @[
...
+ (nullable FLTBattery *)nullableFromList:(NSArray *)list { return (list) ? [FLTBattery fromList:list] : nil; }
- (NSArray *)toList {
  return @[
...
+ (instancetype)makeWithStatus:(nullable NSString *)status
  ...
  pigeonResult.homeLatitude = homeLatitude;
  pigeonResult.homeLongitude = homeLongitude;
  return pigeonResult;
}
+ (FLTDrone *)fromList:(NSArray *)list {
  FLTDrone *pigeonResult = [[FLTDrone alloc] init];
...
- (NSArray *)toList {
  return @[
    ...
    (self.homeLatitude ?: [NSNull null]),
    (self.homeLongitude ?: [NSNull null]),
  ];
}
@end
...
+ (nullable FLTMedia *)nullableFromList:(NSArray *)list { return (list) ? [FLTMedia fromList:list] : nil; }
- (NSArray *)toList {
  return @[
...
+ (nullable FLTStream *)nullableFromList:(NSArray *)list { return (list) ? [FLTStream fromList:list] : nil; }
- (NSArray *)toList {
  return @[
